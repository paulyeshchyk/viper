...
class AppDelegate: UIResponder, UIApplicationDelegate, TheAppProtocol {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        self.wireFrame = WireFrame(app: self)
        self.wireFrame?.run(WireType.LoginWire, completionBlock:  {(wire:WireProtocol) in
